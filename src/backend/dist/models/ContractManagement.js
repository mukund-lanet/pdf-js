...
const ContractManagementSchema = new mongoose_1.Schema({
    documents: [{ type: mongoose_1.Schema.Types.ObjectId, ref: 'Document' }],
    contracts: [{ type: mongoose_1.Schema.Types.ObjectId, ref: 'Contract' }],
    documentsFilters: {
...
exports.default = mongoose_1.default.model('ContractManagement', ContractManagementSchema);
