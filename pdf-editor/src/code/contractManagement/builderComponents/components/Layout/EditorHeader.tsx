...
import { SET_ACTIVE_DOCUMENT, SET_CANVAS_ELEMENTS, SET_CURRENT_PAGE, SET_IS_LOADING, SET_PAGE_DIMENSIONS, SET_PDF_BYTES, SET_PDF_MEDIA, SET_SELECTED_TEXT_ELEMENT, SET_TOTAL_PAGES } from '../../../store/action/contractManagement.actions';
...
const EditorHeader = () => {
  ...
  useEffect(() => {
    const initializeDocument = async () => {
      ...
      if (activeDocument) {
        console.log('Active Document Loaded:', activeDocument);
        console.log('Document Name:', activeDocument.name);
        console.log('Signers:', activeDocument.signers);
      }
    };
    ...
    <div className={styles.toolbarWrapper} >
      ...
      <TextField 
        ...
        onChange={(e: React.ChangeEvent<HTMLInputElement>) => dispatch({ 
          ...
          payload: { ...activeDocument, name: e.target.value } 
        })}
      />
      <Button
        variant={"contained"}
